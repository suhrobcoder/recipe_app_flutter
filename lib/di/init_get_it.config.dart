...
import 'package:recipe_app/data/database/dao/recipe_dao.dart' as _i13;
import 'package:recipe_app/data/database/saved_recipes_database.dart' as _i9;
import 'package:recipe_app/data/model/recipe.dart' as _i18;
import 'package:recipe_app/data/pref/app_config_pref.dart' as _i12;
import 'package:recipe_app/data/pref/settings_pref.dart' as _i15;
...
import 'package:recipe_app/data/repository/saved_recipes_repository.dart'
    as _i14;
import 'package:recipe_app/data/repository/setting_repository.dart' as _i16;
import 'package:recipe_app/di/app_module.dart' as _i22;
import 'package:recipe_app/ui/pages/details/bloc/details_bloc.dart' as _i17;
...
import 'package:recipe_app/ui/pages/search/bloc/search_bloc.dart' as _i10;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i10.SearchBloc>(
        () => _i10.SearchBloc(gh<_i7.RecipeRepository>()));
    ...
    gh.factory<_i16.SettingsRepository>(() => _i16.SettingsRepository(
          gh<_i12.AppConfigPref>(),
          gh<_i15.SettingsPref>(),
        ));
    gh.factoryParam<_i17.DetailsBloc, _i18.Recipe, dynamic>((
      recipe,
      _,
    ) =>
        _i17.DetailsBloc(
          gh<_i7.RecipeRepository>(),
          gh<_i14.SavedRecipesRepository>(),
          recipe,
        ));
    gh.factory<_i19.OnboardingBloc>(
        () => _i19.OnboardingBloc(gh<_i16.SettingsRepository>()));
    gh.factory<_i20.SavedBloc>(
        () => _i20.SavedBloc(gh<_i14.SavedRecipesRepository>()));
    gh.factory<_i21.SettingsBloc>(
        () => _i21.SettingsBloc(gh<_i16.SettingsRepository>()));
    return this;
  }
}
